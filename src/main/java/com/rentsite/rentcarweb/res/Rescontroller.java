...
public class Rescontroller
{
    ...
    public String regRes(Model model)
    {
        return "resRegister";
    }
    ...
    public String regRes2(Model model)
    {
        return "resRegister0";
    }
    ...
    public String searchRes(@RequestParam(value="resNumber", required=false) String resNumber, Model model)
    {
        try
        {
    ...
    public String modiRes()
    {
        return "resModify";
    }

    @PostMapping("/res/modify")
    public String modiRes(@RequestParam(value = "resNumber") String resNumber, Model model)
    {
        ResForm res = resService.findResByResNumber(resNumber);
        if (res != null)
        {
