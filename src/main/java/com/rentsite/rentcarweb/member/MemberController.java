...
public class MemberController
{
    ...
    public String viewMember(@RequestParam(value="id", required=false) String id, Model model) {
        try {
    ...
    public String editMember(@RequestParam(value = "id") String id, Model model) {
        MemberForm member = memberService.findMemberById(id);
        if (member != null) {
            model.addAttribute("member", member);
        } else {
